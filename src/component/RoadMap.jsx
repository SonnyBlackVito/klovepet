            ...
            <div className="hidden lg:block">
              ...
              <div className="relative h-[800px] mb-10">
                ...
                {roadmapPhases.map((phase, index) => {
                  ...
                  const leftPosition = (100 / (roadmapPhases.length + 1)) * (index + 1);
                  ...
                  return (
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        className={`absolute left-1/2 -translate-x-1/2 w-0.5 bg-gradient-to-b ${phase.color} ${
                        ...
                        <div className="relative">
                          ...
                          <motion.div
                            animate={{
                              ...
                              opacity: hoveredPhase === index ? [0.5, 0.8, 0.5] : 0.3
                            }}
                      ...
                      <motion.div
                        ...
                        className={`${isTop ? 'pb-[170px]' : 'pt-[170px]'} cursor-pointer`}
                      >
                        {/* Card Glow */}
                        <motion.div
                          animate={{
                        ...
                        <div className="relative bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl p-5 border-2 border-amber-200 dark:border-gray-700 shadow-2xl overflow-hidden">
                          ...
                          <div className="flex items-center justify-between mb-3">
                            <div className={`${StatusBadge.color} ${StatusBadge.textColor} px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg`}>
                              <StatusBadge.icon className="w-3.5 h-3.5" strokeWidth={2.5} />
                              <span className="text-[10px] font-black tracking-wider">{StatusBadge.text}</span>
                            </div>
                          </div>
                          ...
                          <div className="mb-3">
                            <div className="flex justify-between items-center mb-1.5">
                              <span className="text-[10px] font-bold text-gray-600 dark:text-gray-400 uppercase">Progress</span>
                            ...
                            <div className="h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                              <motion.div
                                ...
                                transition={{ duration: 1.5, delay: 1.3 + index * 0.1, ease: "easeOut" }}
                  ...
                  >
                    <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl p-6 border-2 border-amber-200 dark:border-gray-700 shadow-xl">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        >
                          <div className="relative">
                            <div className={`absolute inset-0 bg-gradient-to-br ${phase.color} rounded-full blur-lg opacity-50`} />
                            <div className={`relative w-14 h-14 bg-gradient-to-br ${phase.color} rounded-full flex items-center justify-center shadow-xl border-3 border-white dark:border-gray-900`}>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-2">
                            <div className={`${StatusBadge.color} ${StatusBadge.textColor} px-2 py-1 rounded-full flex items-center gap-1 text-xs font-black`}>
                              <StatusBadge.icon className="w-3 h-3" />
                              {StatusBadge.text}
                            </div>
                            <div className="text-xs font-bold text-amber-600 dark:text-amber-400">{phase.quarter}</div>
                          </div>
                      ...
                      <div className="mb-4">
                        <div className="flex justify-between mb-1.5">
                          <span className="text-xs text-gray-600 dark:text-gray-400 font-bold">Progress</span>
                        ...
                        {phase.milestones.map((milestone, i) => (
                          <div key={i} className="flex items-center gap-2">
                            <div className={`w-3.5 h-3.5 rounded-full ${
                              milestone.completed ? 'bg-emerald-500' : 'bg-gray-400'
                            }`} />
                            <span className="text-xs text-gray-700 dark:text-gray-300 font-semibold" style={{ fontFamily: 'system-ui' }}>
                              {milestone.text}
                            </span>
                          </div>
                        ))}
                    ...
                    <div className="flex gap-4">
                      ...
                      >
                        <div className="relative">
                          ...
                          <div className={`relative w-16 h-16 bg-gradient-to-br ${phase.color} rounded-full flex items-center justify-center shadow-xl border-4 border-white dark:border-gray-900`}>
                            <phase.icon className="w-8 h-8 text-white" strokeWidth={2.5} />
                          </div>
                        </div>
                      </motion.div>
                      ...
                      <div className="flex-1 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl p-5 border-2 border-amber-200 dark:border-gray-700 shadow-xl">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="text-xs font-bold text-amber-600">{phase.quarter}</div>
                        </div>
                        ...
                        <div className="space-y-2">
                          {phase.milestones.map((milestone, i) => (
                            <div key={i} className="flex items-center gap-2">
                              ...
                              <span className="text-xs text-gray-700 dark:text-gray-300" style={{ fontFamily: 'system-ui' }}>
                                {milestone.text}
                              </span>
                            </div>
                          ))}
          ...
          >
            <div className="relative bg-gradient-to-br from-amber-500 via-orange-500 to-red-600 rounded-3xl p-12 md:p-16 overflow-hidden shadow-2xl border-4 border-white/20">
              ...
              <div className="relative z-10 text-center text-white">
                ...
                >
                  <Award className="w-20 h-20 mx-auto mb-6 drop-shadow-2xl" strokeWidth={2} />
                </motion.div>

                <h3 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 tracking-wider drop-shadow-lg uppercase">
                  JOIN OUR JOURNEY
                </h3>
                <p className="text-xl md:text-2xl mb-10 opacity-95 max-w-2xl mx-auto font-sans leading-relaxed" style={{ fontFamily: 'system-ui, sans-serif' }}>
                  Be part of something extraordinary. Together, we're building the future of pet communities.
                </p>
