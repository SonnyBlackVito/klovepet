...
export default function NFTCard() {
  ...
  const cards = [
    ...
    },
    {
      id: 5,
      image:
        "https://images.unsplash.com/photo-1616097970275-1e187b4ce56c?w=400&h=600&fit=crop",
    },
  ];
  ...
  ">
        <h1 className="font-black tracking-tight py-4">NFT CARD</h1>
      </div>

      {/* Carousel */}
      <div
        className="relative w-full max-w-7xl h-[450px]"
        ...
        sm:w-[220px] sm:h-[320px]  /* tablet */
        md:w-[260px] md:h-[380px]  /* laptop */
        lg:w-[300px] lg:h-[440px]  /* desktop */
        xl:w-[340px] xl:h-[500px]  /* large screen */
      ...
      "
        ...
        <button
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 w-14 h-14 bg-orange-500/90 hover:bg-orange-600 disabled:opacity-30 disabled:cursor-not-allowed text-white rounded-full flex items-center justify-center transition-all z-[60] shadow-lg backdrop-blur-sm">
          <svg
            className="w-7 h-7"
            fill="none"
            stroke="currentColor"
        ...
        <button
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 w-14 h-14 bg-orange-500/90 hover:bg-orange-600 disabled:opacity-30 disabled:cursor-not-allowed text-white rounded-full flex items-center justify-center transition-all z-[60] shadow-lg backdrop-blur-sm">
          <svg
            className="w-7 h-7"
            fill="none"
            stroke="currentColor"
