  ...
  const partners = [
    {
      ...
      description:
        "Creative visionary leading brand strategy and artistic direction for KpopRoad's visual identity.",
    ...
    },
    {
      ...
      role: "Designer",
      description:
        "UI/UX specialist creating intuitive interfaces and stunning visual designs for the KpopRoad platform.",
