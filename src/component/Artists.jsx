...
export default function PartnersSectionComponent() {
  ...
  return (
    <div className="relative z-[3] py-16 md:py-20">
...
function HoloCard({ partner, hoveredCard, setHoveredCard, getCategoryColor, cardVariants }) {
    ...
    >
      <motion.div
        ...
        style={{
          ...
          borderColor: isActive ? 'rgba(254, 244, 205, 0.6)' : 'rgba(255,255,255,0.1)',
        ...
        <div className="relative w-full h-full">
          ...
          <motion.div
            ...
            style={{
              ...
              backgroundPosition: `center, ${mouseX.get() * 100}% ${mouseY.get() * 100}%`,
          ...
          >
            <span 
              className={`inline-block bg-gradient-to-r ${getCategoryColor(partner.category)} text-white px-3 py-1 rounded-full text-xs font-bold backdrop-blur-sm`}
