...
const TokenomicSection = () => {
  ...
  return (
    <div
      className="bg-[#FEFBEA] dark:bg-gray-900 tokenomics-sparkle-bg py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 relative"
      style={{
        backgroundImage: `
    ...
    >
      ...
      <div className="flex flex-row justify-between relative overflow-x-hidden mb-8 sm:mb-12 md:mb-16">
        <div className="flex flex-col relative z-10 w-full">
          <h2
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-normal leading-tight sm:leading-normal max-w-6xl text-gray-900 dark:text-white"
            style={{
              color: "#F26457",
          ...
          <p
            className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl mt-3 sm:mt-4 font-bold max-w-4xl text-gray-700 dark:text-gray-300"
            style={{
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-8 md:gap-10 lg:gap-12 xl:gap-16 min-h-[400px] sm:min-h-[500px] relative z-10">
              ...
              <div key={index} className="flex gap-3 sm:gap-4 items-start">
                ...
                <div className="flex flex-col gap-1 sm:gap-2 flex-1">
                  <p
                    ...
                    className="text-lg sm:text-xl text-black dark:text-white leading-tight"
                  >
                    {item.label}
                  </p>
                  <p className="text-xs sm:text-sm text-black dark:text-gray-300 font-normal">
                    {item.value}
                  </p>
                </div>
              </div>
                    ...
                    <div key={index + colIndex * 3}>
                      <div className="flex gap-3 lg:gap-4 items-start">
                        ...
                        <div className="flex flex-col gap-1 lg:gap-2 flex-1">
                          <p
                            style={{ fontFamily: "'Luckiest Guy', cursive" }}
                            className="text-lg lg:text-xl xl:text-2xl text-black dark:text-white leading-tight"
                          >
                            {item.label}
                          </p>
                          <p className="text-xs lg:text-sm xl:text-base text-black dark:text-gray-300 font-normal">
                            {item.value}
                          </p>
                        </div>
                      </div>
        ...
        <div className="relative animate-tokenomics-reveal hover:animate-tokenomics-glow w-full lg:w-auto flex justify-center">
          <div className="relative max-w-[280px] sm:max-w-[320px] md:max-w-[350px] lg:max-w-[380px] xl:max-w-[400px] w-full h-auto transition-all duration-300 hover:scale-105 lg:hover:scale-110 hover:brightness-105 hover:drop-shadow-[0_0_20px_rgba(186,142,54,0.8)] lg:hover:drop-shadow-[0_0_30px_rgba(186,142,54,1)]">
            <Image
